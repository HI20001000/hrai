...
const NON_NAME_KEYWORD_PATTERN =
  /(简历|簡歷|信息|資訊|资料|資料|优势|優勢|技能|专业|專業|项目|項目|经验|經驗|经历|經歷|工作|教育|评价|評價|求职|求職|学历|學歷|大专|大專|本科|硕士|碩士|博士|公司|科技|银行|銀行|岗位|職位|职位|工程师|工程師|测试|測試|软件|軟件|开发|開發|数据库|資料庫|数据|數據|分析师|分析師|管理|维护|維護|Oracle|MySQL|Hive|SQL|Python|Java|Linux|Hadoop|MongoDB|HBase|Studio)/i
...
const CONTACT_LINE_PATTERN =
  /(@|(?:^|[^\d])1[3-9]\d{9}(?:[^\d]|$)|电话|電話|手机|手機|邮箱|郵箱|Email|性别|性別|^(?:男|女)(?:\s|$|[|｜])|工作经验|工作經驗|求职意向|求職意向|期望薪资|期望薪資|年龄|年齡|政治面貌)/i
